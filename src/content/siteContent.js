export const siteContent = {
  ...
  hero: {
    eyebrow: 'A consortium for people who build the future',
  ...
  work: {
    header: {
      eyebrow: 'What We Do',
      title: 'Curated intelligence, people, and resources.',
      copy: 'For leaders who think in decades, not quarters.',
    },
    cards: [
      {
        icon: 'database',
    ...
    cards: [
      {
        icon: 'globe',
        illustration: 'ai',
        title: 'Interview Collections',
        copy: 'Curated conversations with leaders shaping AI, defense, and public purpose.',
      },
      {
        icon: 'play',
        illustration: 'data',
        title: 'Video Library',
        copy: 'Fast briefings on emerging tech and mission challenges.',
      },
      {
        icon: 'sparkles',
        illustration: 'setup',
        title: 'Leadership Highlights',
        copy: 'Spotlight someone making a difference across the frontier ecosystem.',
      },
    ],
  },
  thinkTank: {
    ...
    timeline: [
      {
        title: 'Closed-door strategy',
        copy: 'High-trust conversations with peers who understand scale.',
      },
      {
        title: 'Early visibility',
        copy: 'Emerging technologies, policies, and programs before they become consensus.',
      },
      {
        title: 'National priorities',
        copy: 'A forum where government and industry collaborate without friction.',
      },
    ],
    stats: [
      { value: '07', label: 'Frontier domains' },
  ...
  partners: {
    header: {
      eyebrow: 'Universities & Events',
      title: 'Bring frontier work into real-world channels.',
      copy: 'Two clear pathways for research groups, universities, societies, and event teams.',
    },
    cards: [
      {
        icon: 'graduation',
        ...
        title: 'Universities',
        copy:
          'Connect research groups to commercialization pathways, Think Tank programs, and national-level conversations.',
      },
      {
        icon: 'calendar',
        ...
        copy:
          'Access speakers for global technology-awareness programs for students, educators, and industry leaders.',
      },
    ],
  },
  contact: {
